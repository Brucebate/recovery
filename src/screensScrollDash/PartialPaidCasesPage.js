...
const PartialPaidCasesPage = () => {
    ...
    const handleBackToDashboard = () => {
        ...
        navigation.navigate('Dashboard', { partialPaidCasesCount: cases.length })
    };

    useEffect(() => {
        // Simulating data fetching
        const fetchPartialPaidCases = async () => {
            try {
                ...
                console.error('Error fetching Partial paid cases:', error);
                setLoading(false);
            }
        };

        fetchPartialPaidCases();
    }, []);
        ...
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                <View style={styles.userSection}>
                    ...
                    <Text style={styles.textName}>Partially Paid Cases</Text>
                </View>
...
export default PartialPaidCasesPage;
