...
const DeclinedCasesPage = () => {
    ...
    const handleBackToDashboard = () => {
        ...
        navigation.navigate('Dashboard', { declinedCasesCount: cases.length })
    };

    useEffect(() => {
        // Simulating data fetching
        const fetchDeclinedCases = async () => {
            try {
        ...
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                <View style={styles.userSection}>
                    ...
                    <Text style={styles.textName}>Declined Cases</Text>
                </View>
...
export default DeclinedCasesPage;
