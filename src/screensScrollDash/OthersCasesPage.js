...
const OthersCasesPage = () => {
    ...
    const handleBackToDashboard = () => {
        ...
        navigation.navigate('Dashboard', { othersCasesCount: cases.length })
    };

    useEffect(() => {
        // Simulating data fetching
        const fetchOthersCases = async () => {
            try {
                ...
                console.error('Error Others cases:', error);
                setLoading(false);
            }
        };
        ...
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                <View style={styles.userSection}>
                    ...
                    <Text style={styles.textName}>Others Cases</Text>
                </View>
...
export default OthersCasesPage;
