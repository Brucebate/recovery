...
const FullyPaidCasesPage = () => {
    ...
    const handleBackToDashboard = () => {
        ...
        navigation.navigate('Dashboard', { fullyPaidCasesCount: cases.length })
    };

    useEffect(() => {
        // Simulating data fetching
        const fetchFullyPaidCases = async () => {
            try {
                ...
                console.error('Error fetching Fully paid cases:', error);
                setLoading(false);
            }
        };
        ...
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                <View style={styles.userSection}>
                    ...
                    <Text style={styles.textName}>Fully Paid Cases</Text>
                </View>
...
export default FullyPaidCasesPage;
