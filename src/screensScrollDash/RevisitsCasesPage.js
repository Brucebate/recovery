...
const RevisitsCasesPage = () => {
    ...
    const handleBackToDashboard = () => {
        ...
        navigation.navigate('Dashboard', { revisitsCasesCount: cases.length })
    };

    useEffect(() => {
        // Simulating data fetching
        const fetchRevisitsCases = async () => {
            try {
                ...
                console.error('Error fetching Revists cases:', error);
                setLoading(false);
            }
        };
        ...
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                <View style={styles.userSection}>
                    ...
                    <Text style={styles.textName}>Revisits Cases</Text>
                </View>
...
export default RevisitsCasesPage;
