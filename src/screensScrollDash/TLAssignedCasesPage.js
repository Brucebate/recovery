...
const TLAssignedCasesPage = () => {
    ...
    const handleBackToDashboard = () => {
        ...
        navigation.navigate('Dashboard', { tlAssignedCasesCount: cases.length })
    };
    ...
    useEffect(() => {
        ...
        const fetchAssignedCases = async () => {
            try {
                ...
                console.error('Error fetching TL Assigned cases:', error);
                setLoading(false);
            }
        };
        ...
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                <View style={styles.userSection}>
                    ...
                    <Text style={styles.textName}>TL Assigned Cases</Text>
                </View>
...
export default TLAssignedCasesPage;
