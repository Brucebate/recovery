...
import Vector from '../assets/svgs/Vector.svg'; // Import user logo
...
const DashboardHeader = () => {
    ...
    <View style={styles.headerContainer}>
        <View style={styles.userSection}>
            <TouchableOpacity style={styles.vector} onPress={handleProfilePage}>
                <Vector/>
            </TouchableOpacity>
            
            <Text style={styles.textName}>Hello User </Text>
        </View>
...
const styles = StyleSheet.create({
        ...
        vector: {
            marginTop: height * 0.00, // Top margin as 1% of screen height
        },
        textName: {
            fontFamily: 'Mansalva',
