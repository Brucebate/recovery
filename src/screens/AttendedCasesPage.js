...
const AttendedCasesPage = () => {
    ...
    const handleBackToDashboard = () => {
        ...
        navigation.navigate('Dashboard', { attendedCasesCount: cases.length })
    };

    useEffect(() => {
        // Simulating data fetching
        const fetchAttendedCases = async () => {
            try {
                ...
                console.error('Error fetching attended cases:', error);
                setLoading(false);
            }
        };
        ...
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                <View style={styles.userSection}>
                    ...
                    <Text style={styles.textName}>Attended Cases</Text>
                </View>
...
export default AttendedCasesPage;
