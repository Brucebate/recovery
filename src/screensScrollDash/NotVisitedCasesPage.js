...
const NotVisitedCasesPage = () => {
    ...
    const handleBackToDashboard = () => {
        ...
        navigation.navigate('Dashboard', { notVisitedCasesCount: cases.length })
    };

    useEffect(() => {
        // Simulating data fetching
        const fetchNotVisitedCases = async () => {
            try {
                ...
                console.error('Error fetching Not Visited cases:', error);
                setLoading(false);
            }
        };

        fetchNotVisitedCases();
    }, []);
        ...
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                <View style={styles.userSection}>
                    ...
                    <Text style={styles.textName}>Not Visited Cases</Text>
                </View>
...
export default NotVisitedCasesPage;
